    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">اختبر وراقب أداء مساعد رؤيا الذكي وتأكد من جودة الاستجابات</p>
        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">تأكد من التعامل مع الأسئلة غير المتعلقة</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-2">
