...
export default function Footer() {
  ...
  const footerLinks = {
    خدماتنا: ["الخدمات الاستشارية", "الحلول الاستثمارية", "التمويل العقاري", "إدارة الثروات"],
    الدعم: ["مركز المساعدة", "الأسئلة الشائعة", "تواصل معنا", "الدعم الفني"],
    الشركة: ["من نحن", "رؤيتنا ورسالتنا", "فريق العمل", "الوظائف"],
  }
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              شريكك الموثوق لتحقيق أهدافك الاستثمارية والمالية بأعلى معايير الجودة والاحترافية.
            </p>

            <div className="space-y-3">
              <div className="flex items-center text-gray-400">
                <MapPin className="w-5 h-5 ml-3 text-cyan-400" />
                <span>سوريا , الامارات العربية المتحدة , المملكة العربية السعودية </span>
              </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-500 mb-4 md:mb-0">
              <p>&copy; 2024 رؤيا كابيتال. جميع الحقوق محفوظة.</p>
            </div>

            <div className="flex items-center space-x-4 space-x-reverse">
              <span className="text-gray-400 ml-4">تابعنا على:</span>
