            ...
            <div className={`${isRTL ? "lg:order-2" : "order-1"} p-8 lg:p-12 flex flex-col justify-center`}>
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a
                  ...
                  className="flex items-center gap-3 px-6 py-3 bg-[#25D366] hover:bg-[#20BA5A] rounded-xl transition-colors duration-200 text-white font-medium btn-3d"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-3 px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-xl transition-colors duration-200 text-white font-medium border border-gray-700 btn-3d"
                >
                ...
                <button className="flex items-center gap-3 px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-xl transition-colors duration-200 text-white font-medium border border-gray-700 btn-3d">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
