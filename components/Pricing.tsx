  ...
  const services = [
    {
      ...
      description:
        "منتجات استثمارية متنوعة تناسب مختلف الأهداف المالية وتطلعات العملاء مع حلول مبتكرة ومتوافقة مع الشريعة.",
      image: "/images/investment-solutions.png",
      icon: <TrendingUp className="w-8 h-8" />,
    },
    {
      title: "وكيل خدمة العملاء و ادارة المواعيد و متابعة الطلبات",
      description: "نظام متكامل لإدارة خدمة العملاء وتنظيم المواعيد ومتابعة جميع الطلبات بكفاءة عالية واحترافية.",
      image: "/images/customer-service-agent.png",
      icon: <Users className="w-8 h-8" />,
    },
    {
      title: "وكيل حسب اختصاصك",
      description: "وكيل ذكي متخصص يتكيف مع مجال خبرتك ويقدم الدعم المناسب لاحتياجاتك المهنية المحددة.",
      image: "/images/specialized-agent.png",
      icon: <Briefcase className="w-8 h-8" />,
    },
    {
      title: "مجموعة وكلاء لادارة الشركات بشكل كامل و احترافي",
      description: "فريق متكامل من الوكلاء المتخصصين لإدارة جميع جوانب الشركة بأعلى معايير الاحترافية والكفاءة.",
    ...
    <div className="py-20 relative z-10">
      ...
      <section id="services" className="mb-32 relative">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white drop-shadow-lg">خدماتنا المتميزة</h2>
          </motion.div>
      ...
      <section id="training" className="mb-32">
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white drop-shadow-lg">مركز التدريب والتطوير</h2>
          </motion.div>
          ...
          >
            <p className="text-lg text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              نلتزم بتطوير مهارات وكلائنا باستمرار لتقديم أفضل الخدمات لعملائنا.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section id="contact" className="relative">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white drop-shadow-lg">تواصل معنا</h2>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-bold mb-4 text-white drop-shadow-md">فريق الدعم الفني</h3>
                  <p className="text-lg text-gray-300 leading-relaxed">
                    متاح على مدار الساعة لمساعدتك في حل أي مشكلات تقنية تواجهها.
                  </p>
                </div>

                <div>
                  <h3 className="text-2xl font-bold mb-4 text-white drop-shadow-md">مدير العلاقات</h3>
                  <p className="text-lg text-gray-300 leading-relaxed">
                    تواصل مباشرة مع مدير علاقات الوكلاء للاستشارات المتخصصة.
                  </p>
                </div>
