              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    ...
                    className="modern-button inline-flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white text-lg font-semibold min-w-[200px]"
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-3 border-2 border-[var(--primary-blue)] text-[var(--primary-blue)] hover:bg-[var(--primary-blue)] hover:text-white px-8 py-4 text-lg font-semibold bg-transparent shadow-2xl hover:shadow-[var(--primary-blue)]/25 transition-all duration-300 rounded-lg min-w-[200px]"
                  >
